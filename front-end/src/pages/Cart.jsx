...
export default function Cart() {
    ...
    const totalPrice = cartItems.reduce((acc, item) => acc + (item.book.price * item.cart_quantity), 0);
                ...
                <div className="overflow-x-auto mt-10 ml-20">
                    <div className="flex justify-between">
                        ...
                        <div className="border-green-500 border-[1px] rounded-lg p-4 mr-10">
                            ...
                            <Link to="/payments" className="btn bg-green-500 text-white mt-5 w-[500px]">ดำเนินการสั่งซื้อ</Link>
                        </div>
                    </div>
                </div>
            )}
